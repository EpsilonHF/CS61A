...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while max(score0 ,score1) < goal:
        if not player:
            ...
            res = take_turn(num_rolls, score1, dice)
            score0 += res
        else:
            num_rolls = strategy1(score1, score0)
            res = take_turn(num_rolls, score0, dice)
            score1 += res
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def comment(score0, score1):
        ...
        gain, last  = score - previous_score, score
        ...
        return announce_highest(who, gain, last)
...
def make_averaged(fn, num_samples=1000):
    ...
    "*** YOUR CODE HERE ***"
    def func(*arg):
        return sum(fn(*arg) for i in range(num_samples)) / num_samples
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if swap_strategy(score, opponent_score, GOAL_SCORE-score) == 0:
        return 0
    return 5
    # END PROBLEM 12
